...
commands_uno = [
    ["cmd_moveToX", "i"], # Move StepperMotorX to a specific position
...
commands_mega = [["cmd_GoHome", "c"],
                ["cmd_MoveCompleteTo", "ci"],
                ["cmd_MoveTo", "ci"],
                ["cmd_SetSpeed", "ci"],
                ["cmd_SetAcceleration", "ci"],
                ["cmd_Stop", "c"],
                ["cmd_Continue", "c"],
                ["cmd_Pulse", "Lii"],
                ["cmd_SetColor", "Li"],
...
class Controller:
    def __init__(self, cmd_arduino_uno):
        self.cmd_arduino_uno = cmd_arduino_uno
...
class StepperMotorController(Controller):
    ...
    def stopX(self):
        ...
        cmd_arduino_uno.send("cmd_stopX")
        # Receive the acknowledgement message from Arduino
        msg = cmd_arduino_uno.receive()
        print(msg)
    ...
    def getPositionX(self):
        ...
        cmd_arduino_uno.send("cmd_getPositionX")
    ...
    def getStateX(self):
        ...
        cmd_arduino_uno.send("cmd_getStateX")
    ...
    def moveToY(self, position):
        ...
        cmd_arduino_uno.send("cmd_moveToY", position)
        # Receive the acknowledgement message from Arduino
        msg = cmd_arduino_uno.receive()
        print(msg)
    ...
    def homeY(self):
        ...
        cmd_arduino_uno.send("cmd_homeY")
        # Receive the acknowledgement message from Arduino
        msg = cmd_arduino_uno.receive()
        print(msg)
    ...
    def stopY(self):
        ...
        cmd_arduino_uno.send("cmd_stopY")
        # Receive the acknowledgement message from Arduino
        msg = cmd_arduino_uno.receive()
        print(msg)
    ...
    def getPositionY(self):
        ...
        cmd_arduino_uno.send("cmd_getPositionY")
        # Receive the position value from Arduino
        msg = cmd_arduino_uno.receive()
        position = msg[1][0]
        return position
    ...
    def getStateY(self):
        ...
        cmd_arduino_uno.send("cmd_getStateY")
        # Receive the state value from Arduino
        msg = cmd_arduino_uno.receive()
        state = msg[1][0]
        return state
